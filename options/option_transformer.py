...
def get_args_parser():
    parser = argparse.ArgumentParser(description='The second stage of SDflow training',
                                     add_help=True,
    ...
    parser.add_argument('--window-size', type=int, default=192, help='training motion length')
    ...
    ## gpt arch
    parser.add_argument("--block-size", type=int, default=47, help="seq len")
